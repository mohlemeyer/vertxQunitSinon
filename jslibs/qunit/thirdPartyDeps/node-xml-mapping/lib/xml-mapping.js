'use strict';
var XMLWriter = require('../../node-xml-writer/lib/xml-writer');
...
exports.dump = function (obj, options) {
  ...
  var sortKeys = function (o) {
    ...
    function keyComparator(a, b) {
      ...
      // MOh, 2013-12-17: Special check to make sure that text nodes are
      // written before other elements
      if (typeof o[a] !== typeof o[b] &&
              a0 !== b0 &&
              (a0 === '$' || b0 === '$')) {
          compA = a0 === '$' || a0 === '#' ? 1 : -1;
          compB = b0 === '$' || b0 === '#' ? 1 : -1;
...
exports.load = function (str, options) {
  ...
  var parser = require("../../sax-js/lib/sax").parser(true, {trim : true, xmlns : false});
  var result = {},
      stack = [],
      cdata = '',
